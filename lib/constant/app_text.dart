    ...
    return Text(
      ...
      style: style ??
          MyText.getStyle(
            textStyle: style,
            color: color,
            fontWeight: fontWeight ?? MyText._defaultTextFontWeight[textType] ?? 500,
            muted: muted,
            letterSpacing: letterSpacing ?? MyText._defaultLetterSpacing[textType] ?? 0.15,
            height: height,
            xMuted: xMuted,
            decoration: decoration,
            wordSpacing: wordSpacing,
            fontSize: fontSize ?? MyText._defaultTextSize[textType],
          ),
      textAlign: textAlign,
      maxLines: maxLines,
      locale: locale,
